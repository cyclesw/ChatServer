...
namespace im
{
    FriendServiceImpl::FriendServiceImpl(const std::shared_ptr<elasticlient::Client> &es_client,
                                         const std::shared_ptr<odb::core::database> &mysql_client,
                                         const ServiceManager::Ptr &channel_manager,
                                         const std::string &user_service_name,
                                         const std::string &message_service_name) :
        _es_user(std::make_shared<ESUser>(es_client)), _mysql_apply(std::make_shared<FriendApplyTable>(mysql_client)),
        ...
        _mysql_relation(std::make_shared<RelationTable>(mysql_client)), _user_service_name(user_service_name),
        _message_service_name(message_service_name), _channels(channel_manager)
    {
    }


    void FriendServiceImpl::GetFriendList(::google::protobuf::RpcController *controller,
                                          const ::im::GetFriendListRequest *request,
                                          ::im::GetFriendListResponse *response, ::google::protobuf::Closure *done)
    {
    ...
    void FriendServiceImpl::FriendRemove(::google::protobuf::RpcController *controller,
                                         const ::im::FriendRemoveRequest *request, ::im::FriendRemoveResponse *response,
    ...
    void FriendServiceImpl::FriendAdd(::google::protobuf::RpcController *controller,
                                      const ::im::FriendAddRequest *request, ::im::FriendAddResponse *response,
                                      ::google::protobuf::Closure *done)
    {
        brpc::ClosureGuard rpc_guard(done);
        // 1. 定义错误回调
    ...
    void FriendServiceImpl::FriendAddProcess(::google::protobuf::RpcController *controller,
                                             const ::im::FriendAddProcessRequest *request,
                                             ::im::FriendAddProcessResponse *response,
                                             ::google::protobuf::Closure *done)
    {
        brpc::ClosureGuard rpc_guard(done);
        // 1. 定义错误回调
    ...
    void FriendServiceImpl::FriendSearch(::google::protobuf::RpcController *controller,
                                         const ::im::FriendSearchRequest *request, ::im::FriendSearchResponse *response,
                                         ::google::protobuf::Closure *done)
    {
        brpc::ClosureGuard rpc_guard(done);
        // 1. 定义错误回调
    ...
    void FriendServiceImpl::GetPendingFriendEventList(::google::protobuf::RpcController *controller,
    ...
    void FriendServiceImpl::GetChatSessionList(::google::protobuf::RpcController *controller,
                                               const ::im::GetChatSessionListRequest *request,
                                               ::im::GetChatSessionListResponse *response,
                                               ::google::protobuf::Closure *done)
    {
        brpc::ClosureGuard rpc_guard(done);
        // 1. 定义错误回调
        ...
        std::string uid = request->user_id();
        // 2. 从数据库中查询出用户的单聊会话列表
        auto sf_list = _mysql_chat_session->GetSingleChatSession(uid);
        ...
        // 3. 从数据库中查询出用户的群聊会话列表
        auto gc_list = _mysql_chat_session->GetGroupChatSession(uid);
    ...
    void FriendServiceImpl::ChatSessionCreate(::google::protobuf::RpcController *controller,
                                              const ::im::ChatSessionCreateRequest *request,
                                              ::im::ChatSessionCreateResponse *response,
                                              ::google::protobuf::Closure *done)
    {
        brpc::ClosureGuard rpc_guard(done);
        // 1. 定义错误回调
    ...
    void FriendServiceImpl::GetChatSessionMember(::google::protobuf::RpcController *controller,
    ...
    bool FriendServiceImpl::GetRecentMessage(const std::string &rid, const std::string &cssid, MessageInfo &msg)
    {
        ...
        MessageStorageService_Stub stub(channel.get());
        ...
        {
            LOG_ERROR("{} - 获取会话 {} 最近消息失败: {}", rid, cssid, rsp.error());
            return false;
        }
    ...
    bool FriendServiceImpl::GetUserInfo(const std::string &rid, const std::unordered_set<std::string> &uid_list,
                                        std::unordered_map<std::string, UserInfo> &user_list)
    {
        ...
        if (rsp.success() == false)
        {
            LOG_ERROR("{} - 批量获取用户信息失败: {}", rid, rsp.error());
            return false;
        }
    ...
    FriendServer::FriendServer(const Discovery::Ptr &service_discoverer, const Register::Ptr &reg_client,
                               const std::shared_ptr<elasticlient::Client> &es_client,
                               const std::shared_ptr<odb::core::database> &mysql_client,
                               const std::shared_ptr<brpc::Server> &server) :
        _service_discoverer(service_discoverer), _reg_client(reg_client), _es_client(es_client),
        _mysql_client(mysql_client), _rpc_server(server)
    {
    }

    void FriendServer::Start()
    {
        _rpc_server->RunUntilAskedToQuit();
    }

    void FriendServerBuilder::make_es_object(const std::vector<std::string> host_list)
    {
        _es_client = ESClientFactory::Create(host_list);
    }

    void FriendServerBuilder::make_mysql_object(const std::string &user, const std::string &pswd,
    ...
    void FriendServerBuilder::make_discovery_object(const std::string &reg_host, const std::string &base_service_name,
                                                    const std::string &user_service_name,
                                                    const std::string &message_service_name)
    {
    ...
    void FriendServerBuilder::make_registry_object(const std::string &reg_host, const std::string &service_name,
    ...
    void FriendServerBuilder::make_mq_object(const std::string &user, const std::string &passwd, const std::string &host,
    ...
    void FriendServerBuilder::make_rpc_server(uint16_t port, int32_t timeout, uint8_t num_threads)
    {
        if (!_es_client)
        {
    ...
    FriendServer::Ptr FriendServerBuilder::build()
    {
        ...
        FriendServer::Ptr server = std::make_shared<FriendServer>(_service_discoverer, _registry_client, _es_client,
